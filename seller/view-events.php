...
?>
                                    <tr>
                                      ...
                                      <td><a href="http://localhost/eventer/event-details.php?name=<?= $rowsEv['paralLink'] ?>&value=<?= password_hash($rowsEv['paralLink'], PASSWORD_DEFAULT) ?><?= password_hash($rowsEv['paralLink'], PASSWORD_DEFAULT) ?><?= password_hash($rowsEv['paralLink'], PASSWORD_DEFAULT) ?><?= password_hash($rowsEv['paralLink'], PASSWORD_DEFAULT) ?>" target="_blank">Link</a></td>
